...
/**
 * Minimal `cn` helper to avoid coupling to a specific utils file or classnames package.
 * Supports strings, arrays, objects for conditional classes.
 */
function cn(...inputs: Array<string | false | null | undefined | Record<string, boolean> | Array<string | false | null | undefined>>): string {
            ...
            return (
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  // formatter can render custom content for the item
